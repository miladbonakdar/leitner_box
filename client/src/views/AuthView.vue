        ...
        <b-card-group class="mt-3" v-if="action === 'register'" deck>
            <b-card header-tag="header" footer-tag="footer">
                ...
                <b-form @submit="onRegister">
                    ...
                    <b-form-group id="register-group-2" label="Your username:" label-for="input-2">
                        <b-form-input
                                id="input-2"
                    ...
                    <div class="row">
                        ...
                        <b-link @click="setAction('login')">
                            <span class="col-12 text-info">Already have an account? login here</span>
                        </b-link>
        ...
        <b-card-group class="mt-3" v-if="action === 'login'" deck>
            <b-card header-tag="header" footer-tag="footer">
                ...
                <b-form @submit="onLogin">
                    ...
                    <b-form-group id="login-group-2" label="Your password:" label-for="login-2">
                        <b-form-input
                                id="login-2"
                    ...
                    <div class="row">
                        ...
                        <b-link @click="setAction('register')">
                            <span class="col-12 text-info">Don't have an account? create a new one here</span>
                        </b-link>
        ...
        methods: {
            ...
            onRegister(evt) {
                ...
                if (this.form.register.rePassword !== this.form.register.password)
                    return this.$toasted.global.warn('passwords are not match please enter them again')
            ...
            onLogin(evt) {
                ...
                login(this.form.login).then(res => {
                    this.$toasted.success(res.message)
